  ...
  */
  ...
  else
  {
    ...
    */
    ...
    snprintf(line, sizeof(line), "%s/%s", driverbin, scheme);
    if (access(line, X_OK))
    {
     /*
             ...
             cups_array_t *exclude)	/* I - Drivers to exclude */
{
  ...
  */
  ...
  snprintf(drivers, sizeof(drivers), "%s", driverbin);
              ...
              int    verbose)		/* I - Be verbose? */
{
  ...
  if (!filename[0])
  {
    ...
    cachedir = CACHEDIR;
    snprintf(filename, filesize, "%s/ppds.dat", cachedir);
  }
